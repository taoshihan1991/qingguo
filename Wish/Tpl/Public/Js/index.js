...
$(function () {
	...
	$('#send-btn').click(function(){
		...
		if(content_obj.val().length>50){
			alert('愿望字数太多');
			return;
		}

		var wish=$('form[name=wish]').serialize();
		$.post(CONTROL,wish,function(data){
