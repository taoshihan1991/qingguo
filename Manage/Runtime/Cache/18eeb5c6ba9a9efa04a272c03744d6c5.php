...
function DelAll()
{
	if(Checked()  <= 0){
		...
		if(confirm("确定要删除选择的信息吗？\n此操作不可以恢复！")){
			form.action="<?php echo U('Cp/betchdel');?>";
			form.submit();
		}
	}
}
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="96%" valign="bottom"><span class="STYLE1">产品管理</span></td>
              </tr>
            </table>			</td>
...
<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
        ...
        <td height="30" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="<?php echo U('Cp/del',array('id'=>$v['id']));?>">删除</a>          | <a href="<?php echo U('Cp/update',array('id'=>$v['id']));?>">修改</a></div></td>
