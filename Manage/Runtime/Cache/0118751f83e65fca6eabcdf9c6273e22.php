...
<br />
<div align="center">
    <form action="<?php echo U('Xwclass/addClass');?>" method="post">
...
上级类别：<select  name="topid">
  <option value="0">作为顶级分类</option>
	<?php if(is_array($xwClass)): foreach($xwClass as $key=>$v): ?><option value='<?php echo ($v["id"]); ?>'><?php $__FOR_START_23511__=0;$__FOR_END_23511__=$v['lev'];for($i=$__FOR_START_23511__;$i < $__FOR_END_23511__;$i+=1){ ?>&nbsp;&nbsp;<?php } ?>|-<?php echo ($v["classname"]); ?></option><?php endforeach; endif; ?>
</select>
...
<?php if(is_array($xwClass)): foreach($xwClass as $key=>$v): ?><tr>
	<td width="86%" style="padding-left: 5px; padding-right: 5px; padding-top: 2px; padding-bottom: 2px"><a href="<?php echo U('Xwclass/update',array('id'=>$v['id']));?>"><?php $__FOR_START_19652__=0;$__FOR_END_19652__=$v['lev'];for($i=$__FOR_START_19652__;$i < $__FOR_END_19652__;$i+=1){ ?>&nbsp;&nbsp;<?php } ?>|-<?php echo ($v["classname"]); ?></a>【<?php echo ($v["xh"]); ?>】</td>
