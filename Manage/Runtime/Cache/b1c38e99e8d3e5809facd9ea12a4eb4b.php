...
<br />
<div align="center">
    <form action="<?php echo U('Cpclass/modify');?>" method="post">
...
上级类别：<select  name="topid">
  <option value="0">作为顶级分类</option>
	<?php if(is_array($cpClass)): foreach($cpClass as $key=>$v): ?><option value='<?php echo ($v["id"]); ?>'
		<?php if($v['id']==$nowClass['topid']): ?>selected<?php endif; ?>
		><?php $__FOR_START_23960__=0;$__FOR_END_23960__=$v['lev'];for($i=$__FOR_START_23960__;$i < $__FOR_END_23960__;$i+=1){ ?>&nbsp;&nbsp;<?php } ?>|-<?php echo ($v["classname"]); ?></option><?php endforeach; endif; ?>
</select>
...
<?php if(is_array($cpClass)): foreach($cpClass as $key=>$v): ?><tr>
	<td width="86%" style="padding-left: 5px; padding-right: 5px; padding-top: 2px; padding-bottom: 2px"><a href="<?php echo U('cpclass/update',array('id'=>$v['id']));?>"><?php $__FOR_START_23025__=0;$__FOR_END_23025__=$v['lev'];for($i=$__FOR_START_23025__;$i < $__FOR_END_23025__;$i+=1){ ?>&nbsp;&nbsp;<?php } ?>|-<?php echo ($v["classname"]); ?></a>【<?php echo ($v["xh"]); ?>】</td>
