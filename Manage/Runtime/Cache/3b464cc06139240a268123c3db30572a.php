...
function DelAll()
{
	if(Checked()  <= 0){
		...
		if(confirm("确定要删除选择的信息吗？\n此操作不可以恢复！")){
			form.action="<?php echo U('key/betchdel');?>";
			form.submit();
		}
	}
}
          ...
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="96%" valign="bottom"><span class="STYLE1">关键词管理</span></td>
              </tr>
            </table>			</td>
  ...
  <tr>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce" id="table1">
      <tr>
        ...
        <td width="25%" bgcolor="d3eaef" class="STYLE6"><div align="center"><span class="STYLE10">关键词</div></td>
	...
	<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
        ...
        <td height="30" bgcolor="#FFFFFF" class="STYLE6"><div align="center"><A href="<?php echo ($v["url"]); ?>" target="_blank"><span class="STYLE19"><?php echo ($v["keyword"]); ?></span></A></div></td>
        <td height="30" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo ($v["url"]); ?></div></td>
        <td height="30" bgcolor="#FFFFFF" class="STYLE19"><div align="center"><?php echo (date("Y-m-d H:i:s",$v["time"])); ?></div></td>
        <td height="30" bgcolor="#FFFFFF"><div align="center" class="STYLE21"><a href="<?php echo U('Key/del',array('id'=>$v['id']));?>">删除</a>          | <a href="<?php echo U('Key/update',array('id'=>$v['id']));?>">修改</a></div></td>
