...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
	<form name="addNEWS" id="AddPro" method="post" action="<?php echo U('About/insert');?>">
	<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce"  id="table1">
      <tr>
        <td height="50" colspan="2" bgcolor="d3eaef" class="STYLE10"><div align="center">单页添加</div>          </td>
        </tr>
      <tr>
        <td width="19%" height="30" bgcolor="#FFFFFF"><div align="right" class="STYLE21">栏目名称：</div></td>
        <td width="81%" bgcolor="#FFFFFF">&nbsp;<input type="text" name="title" value="<?php echo ($v["title"]); ?>"/></td>
      </tr>
      <tr>
