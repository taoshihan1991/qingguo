...
<div id="content">
	<form class="form-horizontal" role="form" id="localityForm" action="<?php echo U('locality/edit',array('lid'=>$info['lid']));?>" method="post">
	<table class="table table-striped table-bordered table-hover">
		...
		<tbody>
			...
			<tr>
				...
				<td><input type="text" name="lname" class="form-control" value="<?php echo ($info["lname"]); ?>" /></td>
			</tr>
			
			<tr>
				<td>地区排序</td>
	
				<td><input type="text" name="sort" class="form-control" value="<?php echo ($info["sort"]); ?>"/></td>
			</tr>
			<tr>
				<td>是否显示</td>
				...
				<td>
					<label>
						<span>显示</span><input type="radio" name="display" value="1" <?php if($info['display']): ?>checked="checked"<?php endif; ?>>
					</label>
					&nbsp;&nbsp;
					<label>
						<span>隐藏</span><input type="radio" name="display" value="0" <?php if(!$info['display']): ?>checked="checked"<?php endif; ?>>
					</label>
				</td>
			</tr>
			<tr>
